...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_AVAGO_APDS9960_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_LSM9DS1_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ZEPHYR_NUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ZEPHYR_NUS_DEFAULT_INSTANCE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STDC_LSM9DS1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ARDUINO_NANO_33_BLE_NRF52840_SENSE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LSM9DS1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960_TRIGGER_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960_ENABLE_ALS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960_PGAIN_4X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960_AGAIN_4X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960_PPULSE_LENGTH_8US, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960_PLED_BOOST_100PCT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APDS9960_PPULSE_COUNT, 8);
