...
inline object* first(object* x) 
{
  return x->car;
}

inline object* second(object* x)
{
  return (car(cdr(x)));
}

inline object* cddr(object* x)   
{
  return (cdr(cdr(x)));
}

inline object* third(object* x)  
{
...
// trb static inline void delay(uint32_t ms);
